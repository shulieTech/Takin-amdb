...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public Response<String> handlerAmdbExceptionThrowable(Throwable e) {
        logger.error("handlerAmdbExceptionThrowable", e);
        return Response.fail(e.getMessage());
    }

    @ExceptionHandler(value = AmdbException.class)
    @ResponseBody
    public Response<String> handlerAmdbException(AmdbException e) {
        logger.error("handlerAmdbException", e);
