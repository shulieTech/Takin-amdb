...
public class HttpUtil {
    ...
    public static String sendGet(String urlOri, Object object) {
        ...
        if (HttpURLConnection.HTTP_OK == conn.getResponseCode()) {
            ...
            log.error("请求失败:Url:{}, ResponseCode:{}, ResponseMessage:{}", urlOri, conn.getResponseCode(), conn.getResponseMessage());
    ...
    public static String sendGet(String urlOri) {
        return sendGet(urlOri, null);
    }

    @SneakyThrows
    public static String sendGetWithHeader(String urlOri, Map<String, String> headerParams) {
        StringBuffer sb = new StringBuffer();
        // 创建url资源
        URL url = new URL(urlOri);
        // 建立http连接
    ...
    public static String sendPost(String urlOri, Object object) {
        ...
        if (HttpURLConnection.HTTP_OK == conn.getResponseCode()) {
            ...
            log.error("请求失败:Url:{}, Params:{}, ResponseCode:{}, ResponseMessage:{}", urlOri, object, conn.getResponseCode(), conn.getResponseMessage());
