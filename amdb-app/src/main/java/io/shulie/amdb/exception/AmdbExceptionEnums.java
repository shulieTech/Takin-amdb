...
public enum AmdbExceptionEnums {
    ...
    TRACE_COMPENSATE_ERROR("AMDB_0400_U0005", "警告: %s"),
     ...
     * 查询influxdb指标
     */
    INFLUXDB_QUERY_PARAM_CHECK_SUCCESS("AMDB_0800_U00000", "参数校验通过"),
    INFLUXDB_QUERY_PARAM_CHECK_LACK_MEASUREMENT("AMDB_0800_U00001", "缺少表名measurement"),
    INFLUXDB_QUERY_PARAM_CHECK_INVALID_TIME("AMDB_0800_U00002", "无效的时间格式"),
    INFLUXDB_QUERY_PARAM_CHECK_INVALID_LIMIT("AMDB_0800_U00003", "limit参数非法"),
    INFLUXDB_QUERY_PARAM_CHECK_NOT_SUPPORTED_ORDERBY("AMDB_0800_U00004", "orderBy参数不支持"),
    INFLUXDB_QUERY_PARAM_CHECK_LACK_GROUPBY_TAGS("AMDB_0800_U00005", "缺少groupby分组tag字段"),
    INFLUXDB_QUERY_PARAM_CHECK_LACK_AGGREGATE_STRATEGY("AMDB_0800_U00006", "缺少聚合函数"),
    INFLUXDB_QUERY_PARAM_CHECK_NOT_SUPPORTED_FIELDSANDAGGFIELDS("AMDB_0800_U00007", "聚合字段和非聚合字段不能同时查询"),
